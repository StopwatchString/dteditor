...
struct UserHeaderLabelBlob
{
    ...
    std::array<std::byte, 8>  longitudeOfOriginArcSeconds;           // 5-12  | Longitude of origin
    std::array<std::byte, 8>  latitudeOfOriginArcSeconds;            // 13-20 | Latitude of origin
...
struct DataSetIdentificationBlob
{
    ...
    std::array<std::byte, 9>   latitudeOfOriginArcSeconds;  // 186-194 | Latitude of origin
    std::array<std::byte, 10>  longitudeOfOriginArcSeconds; // 195-204 | Longitude of origin
